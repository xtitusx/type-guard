            ...
            case 'isUndefined':
                return value === undefined
                    ...
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is expected to be undefined but is not: ${value}`)
                          .build();
            case 'isNotUndefined':
                return value !== undefined
                    ? new GuardResult.Builder().withSuccess(true).build()
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is not expected to be undefined but is: ${value}`)
                          .build();
            case 'isNull':
                return value === null
                    ? new GuardResult.Builder().withSuccess(true).build()
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is expected to be null but is not: ${value}`)
                          .build();
            case 'isNotNull':
                return value !== null
                    ? new GuardResult.Builder().withSuccess(true).build()
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is not expected to be null but is: ${value}`)
                          .build();
            case 'isNil':
                return value === undefined || value === null
                    ...
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is expected to be undefined or null but is not: ${value}`)
                          .build();
            case 'isNotNil':
                return value !== undefined && value !== null
                    ? new GuardResult.Builder().withSuccess(true).build()
                    : new GuardResult.Builder()
                          .withSuccess(false)
                          .withMessage(`value is not expected to be undefined or null but is: ${value}`)
                          .build();
        }
    }
