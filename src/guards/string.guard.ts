...
export class StringGuard extends Guard<StringRule> {
     ...
     * @remarks Chainable method.
     * @param alphabet - {@link https://en.wikipedia.org/wiki/ISO_basic_Latin_alphabet | 'basic-latin'} | {@link https://en.wikipedia.org/wiki/List_of_precomposed_Latin_characters_in_Unicode | 'precomposed-latin'} | {@link https://en.wikipedia.org/wiki/French_orthography | 'fre'}. Default is 'basic-latin'.
     * ```ts
     * alphabet:
